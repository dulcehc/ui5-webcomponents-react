...
>
  <h3>Structure</h3>A <code>Dialog</code> consists of a header, content, and a
  footer for action buttons. The <code>Dialog</code> is usually displayed at the
      ...
      return (
        <>
          ...
          <Dialog
            ...
            header={
              <Bar
                contentMiddle={<Title>Dialog</Title>}
