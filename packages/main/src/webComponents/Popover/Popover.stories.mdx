...
>
  ...
  <b>Note:</b> The <code>Popover</code> is closed when the user clicks or taps outside
  the popover or selects an action within the popover. You can prevent this with
  the <code>modal</code> property.
</div>
      ...
      return (
        <>
          ...
          <Popover
            ...
            header={
              <Bar
                contentMiddle={<Title>Popover</Title>}
                contentRight={<Icon name="settings" />}
              />
            }
            footer={
              <Bar
                contentRight={<Button onClick={handleClose}>Close</Button>}
              />
            }
          >
