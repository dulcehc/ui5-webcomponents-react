...
export interface GroupHeaderListItemPropTypes
 ...
 */
const GroupHeaderListItem: FC<GroupHeaderListItemPropTypes> = withWebComponent<
  GroupHeaderListItemPropTypes
>('ui5-li-groupheader', [], ['selected'], [], []);
